...
{{-- Tinder-inspired Hero Section (No changes here, it was already good) --}}
<section class="relative overflow-hidden min-h-screen flex flex-col justify-between pt-16 pb-12">
    {{-- Custom Pink/Purple Gradient Background (Matching your brand theme) --}}
    ...
    {{-- Hero Content (Tinder-like bold headline, centered) --}}
    <div class="relative z-10 max-w-5xl mx-auto px-6 text-center flex flex-col items-center justify-center flex-grow"> 
        <h1 class="text-6xl md:text-8xl font-extrabold leading-none text-white drop-shadow-lg animate-fade-in-up">
            Start Your Journey. <span class="block mt-4 text-4xl md:text-6xl font-medium opacity-90">52 Weeks to Forever.</span>
        </h1>
        <p class="mt-8 text-white/90 text-xl md:text-2xl max-w-3xl animate-fade-in-up delay-200">
            Meaningful connections for the long run. Discover yourself, find your match.
        </p>
        ...
        <div class="mt-12">
            <a href="{{ route('register') }}" class="inline-flex items-center gap-3 px-10 py-5 text-xl rounded-full bg-white text-purple-600 font-bold shadow-xl transform hover:bg-gray-100 hover:scale-105 transition duration-300 animate-fade-in-up delay-400">
                Join The Love Project
            </a>
        </div>

        <div class="mt-8 text-white text-lg font-medium animate-fade-in-up delay-600">
            Join 98,000+ members today.
        </div>
    </div>
    
    {{-- Visual element (your dashboard mockup) placed at the bottom, peeking out --}}
    <div class="relative z-0 max-w-7xl mx-auto px-6 mt-auto text-center hidden md:block animate-fade-in-up delay-800">
        {{-- Your preferred dashboard image, slightly peeking from the bottom --}}
        <img src="{{ asset('images/original-dashboard-with-gradient.png') }}" alt="The Love Project Web Dashboard Preview" class="w-[800px] lg:w-[1000px] h-auto rounded-3xl shadow-2xl mx-auto translate-y-1/3"> 
    </div>
</section>
<hr class="border-t border-gray-100">

{{-- How It Works Section (Tinder-inspired Cards) --}}
<section id="how" class="py-20 bg-white">
    <div class="max-w-6xl mx-auto px-6 text-center">
        <h2 class="text-4xl font-extrabold text-gray-800 mb-4">How Love Happens Here</h2>
        <p class="text-lg text-gray-600 max-w-xl mx-auto mb-16">
            We've redesigned dating for true connection and growth.
        </p>

        <div class="grid grid-cols-1 md:grid-cols-3 gap-8"> {{-- Adjusted gap for slightly larger cards --}}
            {{-- Card 1: Discover Yourself --}}
            <div class="relative flex flex-col items-center p-8 bg-gradient-to-br from-pink-50 to-purple-50 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300">
                <div class="w-24 h-24 mb-6 flex items-center justify-center bg-white rounded-full shadow-md text-pink-500">
                    {{-- Icon for Self-Discovery (Example: Lightbulb or Person) --}}
                ...
                <h3 class="text-2xl font-bold text-gray-800 mb-3">Discover Yourself</h3>
                <p class="text-gray-600 text-base max-w-xs">Weekly lessons & quizzes to understand your unique love language and grow.</p>
            </div>

            {{-- Card 2: Find Your Match --}}
            <div class="relative flex flex-col items-center p-8 bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300">
                <div class="w-24 h-24 mb-6 flex items-center justify-center bg-white rounded-full shadow-md text-purple-500">
                    {{-- Icon for Matching (Example: Heart or Users) --}}
                ...
                <h3 class="text-2xl font-bold text-gray-800 mb-3">Find Your Match</h3>
                <p class="text-gray-600 text-base max-w-xs">Receive curated, highly compatible matches based on deep personality insights.</p>
            </div>

            {{-- Card 3: Build Forever --}}
            <div class="relative flex flex-col items-center p-8 bg-gradient-to-br from-pink-50 to-purple-50 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300">
                <div class="w-24 h-24 mb-6 flex items-center justify-center bg-white rounded-full shadow-md text-pink-500">
                    {{-- Icon for Commitment/Growth (Example: Ring or Intertwined hands) --}}
                    <svg class="w-12 h-12" fill="currentColor" viewBox="0 0 24 24"><path d="M12 21s-8-4.978-8-11a5 5 0 0110 0 5 5 0 0110 0c0 6.022-8 11-8 11zM12 11a3 3 0 100-6 3 3 0 000 6z"/></svg>
                </div>
                <h3 class="text-2xl font-bold text-gray-800 mb-3">Build Forever</h3>
                <p class="text-gray-600 text-base max-w-xs">Connect, chat, and grow together, guided by our unique 52-week journey.</p>
            </div>
        </div>
    </div>
</section>
...
{{-- Call to Action Section (Simplified, Tinder-like) --}}
<section class="py-16 bg-gradient-to-r from-pink-600 to-purple-700 text-white text-center">
    <div class="max-w-4xl mx-auto px-6">
        <h2 class="text-4xl font-extrabold mb-4">Your Story Starts Here.</h2>
        <p class="text-xl font-medium opacity-90 max-w-2xl mx-auto mb-8">
            Ready for a relationship that truly lasts? Join The Love Project today.
        </p>
