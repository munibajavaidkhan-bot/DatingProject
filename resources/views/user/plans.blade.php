...
<div class="row g-3 justify-content-center mb-5">
    @php
    $plans = [
        ['name'=>'Free','slug'=>'free','badge_color'=>'#6b7280','is_featured'=>false,
         'price_monthly'=>0,'price_yearly'=>0,
         'features'=>['3 matches per day','10 messages per day','Love Quiz access','First 4 weeks of content','Community forum'],
         'limits'=>['See who liked you','Profile boost','Video chat','Advanced filters'],
        ],
        ['name'=>'Basic','slug'=>'basic','badge_color'=>'#3b82f6','is_featured'=>false,
         'price_monthly'=>14.99,'price_yearly'=>119.99,
         'features'=>['10 matches per day','Unlimited messaging','Read receipts','26 weeks of content','Advanced filters','Priority support'],
         'limits'=>['See who liked you','Profile boost','Video chat'],
        ],
        ['name'=>'Premium','slug'=>'premium','badge_color'=>'#ec4899','is_featured'=>true,
         'price_monthly'=>29.99,'price_yearly'=>239.99,
         'features'=>['Unlimited matches','Unlimited messaging','See who liked you','Full 52 weeks','Profile boost 2x/month','Video chat','Compatibility reports'],
         'limits'=>['Personal coach'],
        ],
        ['name'=>'VIP','slug'=>'vip','badge_color'=>'#a855f7','is_featured'=>false,
         'price_monthly'=>79.99,'price_yearly'=>599.99,
         'features'=>['Everything in Premium','Personal matchmaking coach','Weekly coaching calls','Professionally written profile','Priority curation','VIP community'],
         'limits'=>[],
        ],
    ];
    @endphp
...
function choosePlan(slug) {
    // Redirect to payment — hook up Stripe/PayPal here
    alert(`Redirecting to checkout for ${slug} plan...\n\nIntegrate Stripe or PayPal here.`);
}
</script>
@endpush