...
<title>{{ $story->title }} — The Love Project</title>
...
<section class="hero hero-sub">
  ...
  <div class="container">
    <div class="hero-inner">
      <span class="eyebrow">{{ $story->categoryRel?->name ?? 'Deep Reads' }}</span>
      <h1>{{ $story->title }}</h1>
    </div>
  </div>
</section>
...
<section class="container">
  <article class="story-detail reveal">
    @if($story->cover_image)
    <img class="story-cover" src="{{ asset('images/' . $story->cover_image) }}" alt="{{ $story->title }}">
    @endif
    ...
    <div class="story-back">
      <a class="back-link" href="{{ route('stories.index') }}">
        <span>&larr;</span> Back To Stories
      </a>
    </div>
  </article>
  ...
  <div class="related reveal">
    ...
    <div class="story-grid">
      ...
      <article class="story-card reveal">
        ...
        <div class="s-body">
          <span class="cat">{{ $r->categoryRel?->name ?? 'Stories' }}</span>
          <h3><a href="{{ route('stories.show', $r->slug) }}">{{ $r->title }}</a></h3>
          <div class="s-meta">
            ...
            <a class="read-story" href="{{ route('stories.show', $r->slug) }}">Read Story <span>&rarr;</span></a>
          </div>
        </div>
      </article>
      @endforeach
